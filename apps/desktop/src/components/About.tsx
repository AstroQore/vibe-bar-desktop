  ...
  return (
    <div className="about">
      ...
      <p className="status-line" style={{ marginTop: 20, whiteSpace: "normal" }}>
        This preview fetches Codex and Claude quota directly and reads every
        other provider from the shared cache. It never writes shared Vibe Bar
        state — see docs/SHARED-STORAGE.md.
      </p>
