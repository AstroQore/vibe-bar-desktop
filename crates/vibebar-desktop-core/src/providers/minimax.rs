...
mod tests {
    ...
    fn zero_limit_service_placeholders_do_not_hide_model_rows() {
        let body = br#"{"data":{"services":[{"service_type":"coding","limit":0},{"service_type":"coding","limit":100},{"service_type":"coding","limit":100,"usage":-10}],"model_remains":[{"model_name":"MiniMax-M2","current_interval_total_count":100,"current_interval_usage_count":25,"current_weekly_total_count":100}]}}"#;
