...
| **Mini window** |
| Layouts | ● 7 | ◐ 3 | regular, compact, ledger, strip, tile, focus, rail. Desktop has the first three; it follows the shared `miniWindow.displayMode` and falls back to regular for the rest |
